...
export default class BooksPage extends Component {
    state = {
        ...
        postsLength: this.props.data.posts.edges,
    }
    ...
    render() {
        const { filteredPosts, searchTerm, currentCategories, postsLength } = this.state
        const filterCount = filteredPosts.length
        const postCount = postsLength.length
